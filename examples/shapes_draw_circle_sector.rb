...
if __FILE__ == $PROGRAM_NAME
  ...
  until WindowShouldClose()
    BeginDrawing()
      ...
      # Draw GUI controls
      #------------------------------------------------------------------------------
      startAngle = GuiSliderBar(Rectangle.create(600, 40, 120, 20), "StartAngle", nil, startAngle, 0, 720)
      endAngle = GuiSliderBar(Rectangle.create(600, 70, 120, 20), "EndAngle", nil, endAngle, 0, 720)

      outerRadius = GuiSliderBar(Rectangle.create(600, 140, 120, 20), "Radius", nil, outerRadius, 0, 200)
      segments = GuiSliderBar(Rectangle.create(600, 170, 120, 20), "Segments", nil, segments, 0, 100)
      #------------------------------------------------------------------------------
