...
module Raylib
  ...
  def self.setup_rlgl_symbols()
    ...
    args = {
      ...
      :rlSetMatrixProjection => [:int],
      :rlSetMatrixModelview => [:int],
      :rlSetMatrixProjectionStereo => [:int, :int],
      :rlSetMatrixViewOffsetStereo => [:int, :int],
      :rlLoadDrawCube => [],
      :rlLoadDrawQuad => [],
    }
    retvals = {
      ...
      :rlSetShader => :void,
      :rlGetMatrixModelview => :int,
      :rlGetMatrixProjection => :int,
      :rlGetMatrixTransform => :int,
      :rlGetMatrixProjectionStereo => :int,
      :rlGetMatrixViewOffsetStereo => :int,
