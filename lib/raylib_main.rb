...
module Raylib
  ...
  def self.setup_raylib_main_symbols()
    symbols = [
      :InitWindow,
      :WindowShouldClose,
      :CloseWindow,
    ...
    args = {
      ...
      :GetShaderLocation => [Shader, :pointer],
      :GetShaderLocationAttrib => [Shader, :pointer],
      :SetShaderValue => [Shader, :int, :pointer, :int],
      :SetShaderValueV => [Shader, :int, :pointer, :int, :int],
      :SetShaderValueMatrix => [Shader, :int, Matrix],
      :SetShaderValueTexture => [Shader, :int, Texture2D],
      :UnloadShader => [Shader],
      :GetMouseRay => [Vector2, Camera],
      :GetCameraMatrix => [Camera],
      :GetCameraMatrix2D => [Camera2D],
      :GetWorldToScreen => [Vector3, Camera],
      :GetWorldToScreenEx => [Vector3, Camera, :int, :int],
      :GetWorldToScreen2D => [Vector2, Camera2D],
      :GetScreenToWorld2D => [Vector2, Camera2D],
      :SetTargetFPS => [:int],
      :GetFPS => [],
      :GetFrameTime => [],
      :GetTime => [],
      ...
      :DrawLineV => [Vector2, Vector2, Color],
      :DrawLineEx => [Vector2, Vector2, :float, Color],
      :DrawLineBezier => [Vector2, Vector2, :float, Color],
      :DrawLineBezierQuad => [Vector2, Vector2, Vector2, :float, Color],
      :DrawLineBezierCubic => [Vector2, Vector2, Vector2, Vector2, :float, Color],
      :DrawLineStrip => [:pointer, :int, Color],
      :DrawCircle => [:int, :int, :float, Color],
      :DrawCircleSector => [Vector2, :float, :float, :float, :int, Color],
      :DrawCircleSectorLines => [Vector2, :float, :float, :float, :int, Color],
      :DrawCircleGradient => [:int, :int, :float, Color, Color],
      :DrawCircleV => [Vector2, :float, Color],
      :DrawCircleLines => [:int, :int, :float, Color],
      :DrawEllipse => [:int, :int, :float, :float, Color],
      :DrawEllipseLines => [:int, :int, :float, :float, Color],
      :DrawRing => [Vector2, :float, :float, :float, :float, :int, Color],
      :DrawRingLines => [Vector2, :float, :float, :float, :float, :int, Color],
      :DrawRectangle => [:int, :int, :int, :int, Color],
      :DrawRectangleV => [Vector2, Vector2, Color],
      :DrawRectangleRec => [Rectangle, Color],
      :DrawRectanglePro => [Rectangle, Vector2, :float, Color],
      :DrawRectangleGradientV => [:int, :int, :int, :int, Color, Color],
      :DrawRectangleGradientH => [:int, :int, :int, :int, Color, Color],
      :DrawRectangleGradientEx => [Rectangle, Color, Color, Color, Color],
      :DrawRectangleLines => [:int, :int, :int, :int, Color],
      :DrawRectangleLinesEx => [Rectangle, :float, Color],
      :DrawRectangleRounded => [Rectangle, :float, :int, Color],
      :DrawRectangleRoundedLines => [Rectangle, :float, :int, :float, Color],
      :DrawTriangle => [Vector2, Vector2, Vector2, Color],
      :DrawTriangleLines => [Vector2, Vector2, Vector2, Color],
      :DrawTriangleFan => [:pointer, :int, Color],
      :DrawTriangleStrip => [:pointer, :int, Color],
      :DrawPoly => [Vector2, :int, :float, :float, Color],
      :DrawPolyLines => [Vector2, :int, :float, :float, Color],
      :DrawPolyLinesEx => [Vector2, :int, :float, :float, :float, Color],
      ...
      :CheckCollisionPointCircle => [Vector2, Vector2, :float],
      :CheckCollisionPointTriangle => [Vector2, Vector2, Vector2, Vector2],
      :CheckCollisionLines => [Vector2, Vector2, Vector2, Vector2, :pointer],
      :CheckCollisionPointLine => [Vector2, Vector2, Vector2, :int],
      :GetCollisionRec => [Rectangle, Rectangle],
      :LoadImage => [:pointer],
      ...
      :LoadImageFromScreen => [],
      :UnloadImage => [Image],
      :ExportImage => [Image, :pointer],
      :ExportImageAsCode => [Image, :pointer],
      :GenImageColor => [:int, :int, Color],
      :GenImageGradientV => [:int, :int, Color, Color],
      :GenImageGradientH => [:int, :int, Color, Color],
      :GenImageGradientRadial => [:int, :int, :float, Color, Color],
      :GenImageChecked => [:int, :int, :int, :int, Color, Color],
      :GenImageWhiteNoise => [:int, :int, :float],
      :GenImageCellular => [:int, :int, :int],
      :ImageCopy => [Image],
      :ImageFromImage => [Image, Rectangle],
      :ImageText => [:pointer, :int, Color],
      :ImageTextEx => [Font, :pointer, :float, :float, Color],
      :ImageFormat => [:pointer, :int],
      :ImageToPOT => [:pointer, Color],
      :ImageCrop => [:pointer, Rectangle],
      :ImageAlphaCrop => [:pointer, :float],
      :ImageAlphaClear => [:pointer, Color, :float],
      :ImageAlphaMask => [:pointer, Image],
      :ImageAlphaPremultiply => [:pointer],
      :ImageResize => [:pointer, :int, :int],
      :ImageResizeNN => [:pointer, :int, :int],
      :ImageResizeCanvas => [:pointer, :int, :int, :int, :int, Color],
      ...
      :ImageColorTint => [:pointer, Color],
      :ImageColorInvert => [:pointer],
      :ImageColorGrayscale => [:pointer],
      :ImageColorContrast => [:pointer, :float],
      :ImageColorBrightness => [:pointer, :int],
      :ImageColorReplace => [:pointer, Color, Color],
      :LoadImageColors => [Image],
      :LoadImagePalette => [Image, :int, :pointer],
      :UnloadImageColors => [:pointer],
      :UnloadImagePalette => [:pointer],
      :GetImageAlphaBorder => [Image, :float],
      :GetImageColor => [Image, :int, :int],
      :ImageClearBackground => [:pointer, Color],
      :ImageDrawPixel => [:pointer, :int, :int, Color],
      :ImageDrawPixelV => [:pointer, Vector2, Color],
      :ImageDrawLine => [:pointer, :int, :int, :int, :int, Color],
      :ImageDrawLineV => [:pointer, Vector2, Vector2, Color],
      :ImageDrawCircle => [:pointer, :int, :int, :int, Color],
      :ImageDrawCircleV => [:pointer, Vector2, :int, Color],
      :ImageDrawRectangle => [:pointer, :int, :int, :int, :int, Color],
      :ImageDrawRectangleV => [:pointer, Vector2, Vector2, Color],
      :ImageDrawRectangleRec => [:pointer, Rectangle, Color],
      :ImageDrawRectangleLines => [:pointer, Rectangle, :int, Color],
      :ImageDraw => [:pointer, Image, Rectangle, Rectangle, Color],
      :ImageDrawText => [:pointer, :pointer, :int, :int, :int, Color],
      :ImageDrawTextEx => [:pointer, Font, :pointer, Vector2, :float, :float, Color],
      :LoadTexture => [:pointer],
      :LoadTextureFromImage => [Image],
      :LoadTextureCubemap => [Image, :int],
      :LoadRenderTexture => [:int, :int],
      :UnloadTexture => [Texture2D],
      :UnloadRenderTexture => [RenderTexture2D],
      :UpdateTexture => [Texture2D, :pointer],
      :UpdateTextureRec => [Texture2D, Rectangle, :pointer],
      :GenTextureMipmaps => [:pointer],
      :SetTextureFilter => [Texture2D, :int],
      :SetTextureWrap => [Texture2D, :int],
      :DrawTexture => [Texture2D, :int, :int, Color],
      :DrawTextureV => [Texture2D, Vector2, Color],
      :DrawTextureEx => [Texture2D, Vector2, :float, :float, Color],
      :DrawTextureRec => [Texture2D, Rectangle, Vector2, Color],
      :DrawTextureQuad => [Texture2D, Vector2, Vector2, Rectangle, Color],
      :DrawTextureTiled => [Texture2D, Rectangle, Rectangle, Vector2, :float, :float, Color],
      :DrawTexturePro => [Texture2D, Rectangle, Rectangle, Vector2, :float, Color],
      :DrawTextureNPatch => [Texture2D, NPatchInfo, Rectangle, Vector2, :float, Color],
      :DrawTexturePoly => [Texture2D, Vector2, :pointer, :pointer, :int, Color],
      :Fade => [Color, :float],
      :ColorToInt => [Color],
      ...
      :ColorAlphaBlend => [Color, Color, Color],
      :GetColor => [:uint],
      :GetPixelColor => [:pointer, :int],
      :SetPixelColor => [:pointer, Color, :int],
      :GetPixelDataSize => [:int, :int, :int],
      :GetFontDefault => [],
      :LoadFont => [:pointer],
      :LoadFontEx => [:pointer, :int, :pointer, :int],
      :LoadFontFromImage => [Image, Color, :int],
      ...
      :UnloadFont => [Font],
      :DrawFPS => [:int, :int],
      :DrawText => [:pointer, :int, :int, :int, Color],
      :DrawTextEx => [Font, :pointer, Vector2, :float, :float, Color],
      :DrawTextPro => [Font, :pointer, Vector2, Vector2, :float, :float, :float, Color],
      :DrawTextCodepoint => [Font, :int, Vector2, :float, Color],
      :MeasureText => [:pointer, :int],
      :MeasureTextEx => [Font, :pointer, :float, :float],
      :GetGlyphIndex => [Font, :int],
      :GetGlyphInfo => [Font, :int],
      :GetGlyphAtlasRec => [Font, :int],
      ...
      :DrawLine3D => [Vector3, Vector3, Color],
      :DrawPoint3D => [Vector3, Color],
      :DrawCircle3D => [Vector3, :float, Vector3, :float, Color],
      :DrawTriangle3D => [Vector3, Vector3, Vector3, Color],
      :DrawTriangleStrip3D => [:pointer, :int, Color],
      :DrawCube => [Vector3, :float, :float, :float, Color],
      :DrawCubeV => [Vector3, Vector3, Color],
      :DrawCubeWires => [Vector3, :float, :float, :float, Color],
      :DrawCubeWiresV => [Vector3, Vector3, Color],
      :DrawCubeTexture => [Texture2D, Vector3, :float, :float, :float, Color],
      :DrawCubeTextureRec => [Texture2D, Rectangle, Vector3, :float, :float, :float, Color],
      :DrawSphere => [Vector3, :float, Color],
      :DrawSphereEx => [Vector3, :float, :int, :int, Color],
      :DrawSphereWires => [Vector3, :float, :int, :int, Color],
      :DrawCylinder => [Vector3, :float, :float, :float, :int, Color],
      :DrawCylinderEx => [Vector3, Vector3, :float, :float, :int, Color],
      :DrawCylinderWires => [Vector3, :float, :float, :float, :int, Color],
      :DrawCylinderWiresEx => [Vector3, Vector3, :float, :float, :int, Color],
      ...
      :DrawBillboardRec => [Camera, Texture2D, Rectangle, Vector3, Vector2, Color],
      :DrawBillboardPro => [Camera, Texture2D, Rectangle, Vector3, Vector3, Vector2, Vector2, :float, Color],
      :UploadMesh => [:pointer, :bool],
      :UpdateMeshBuffer => [Mesh, :int, :pointer, :int, :int],
      :UnloadMesh => [Mesh],
      :DrawMesh => [Mesh, Material, Matrix],
      :DrawMeshInstanced => [Mesh, Material, :pointer, :int],
      :ExportMesh => [Mesh, :pointer],
      ...
      :SetMaterialTexture => [:pointer, :int, Texture2D],
      :SetModelMeshMaterial => [:pointer, :int, :int],
      :LoadModelAnimations => [:pointer, :pointer],
      :UpdateModelAnimation => [Model, ModelAnimation, :int],
      :UnloadModelAnimation => [ModelAnimation],
      :UnloadModelAnimations => [:pointer, :uint],
      :IsModelAnimationValid => [Model, ModelAnimation],
      :CheckCollisionSpheres => [Vector3, :float, Vector3, :float],
      :CheckCollisionBoxes => [BoundingBox, BoundingBox],
      :CheckCollisionBoxSphere => [BoundingBox, Vector3, :float],
      :GetRayCollisionSphere => [Ray, Vector3, :float],
      :GetRayCollisionBox => [Ray, BoundingBox],
      :GetRayCollisionModel => [Ray, Model],
      :GetRayCollisionMesh => [Ray, Mesh, Matrix],
      :GetRayCollisionTriangle => [Ray, Vector3, Vector3, Vector3],
      :GetRayCollisionQuad => [Ray, Vector3, Vector3, Vector3, Vector3],
      :InitAudioDevice => [],
      :CloseAudioDevice => [],
      :IsAudioDeviceReady => [],
      ...
      :UpdateSound => [Sound, :pointer, :int],
      :UnloadWave => [Wave],
      :UnloadSound => [Sound],
      :ExportWave => [Wave, :pointer],
      :ExportWaveAsCode => [Wave, :pointer],
      :PlaySound => [Sound],
      :StopSound => [Sound],
      :PauseSound => [Sound],
      :ResumeSound => [Sound],
      ...
      :SetSoundVolume => [Sound, :float],
      :SetSoundPitch => [Sound, :float],
      ...
      :SeekMusicStream => [Music, :float],
      :SetMusicVolume => [Music, :float],
      :SetMusicPitch => [Music, :float],
      :GetMusicTimeLength => [Music],
      :GetMusicTimePlayed => [Music],
      :LoadAudioStream => [:uint, :uint, :uint],
      :UnloadAudioStream => [AudioStream],
      :UpdateAudioStream => [AudioStream, :pointer, :int],
      ...
      :SetAudioStreamVolume => [AudioStream, :float],
      :SetAudioStreamPitch => [AudioStream, :float],
    ...
    retvals = {
      ...
      :GetCameraMatrix2D => Matrix,
      :GetWorldToScreen => Vector2,
      :GetWorldToScreenEx => Vector2,
      ...
      :GenImageColor => Image,
      :GenImageGradientV => Image,
      :GenImageGradientH => Image,
      ...
      :LoadTextureFromImage => Texture2D,
      :LoadTextureCubemap => TextureCubemap,
      :LoadRenderTexture => RenderTexture2D,
      :UnloadTexture => :void,
      ...
      :MeasureText => :int,
      :MeasureTextEx => Vector2,
      :GetGlyphIndex => :int,
      :GetGlyphInfo => GlyphInfo,
      :GetGlyphAtlasRec => Rectangle,
      ...
      :GetRayCollisionModel => RayCollision,
    ...
    symbols.each do |sym|
      begin
        pp attach_function sym, args[sym], retvals[sym]
