...
cd build
%CMAKE_EXE% -G "MSYS Makefiles" -D GRAPHICS=GRAPHICS_API_OPENGL_43 -D CMAKE_BUILD_TYPE=Release -D BUILD_SHARED_LIBS=OFF -D BUILD_EXAMPLES=OFF -D CMAKE_C_COMPILER=gcc ../raylib
make
