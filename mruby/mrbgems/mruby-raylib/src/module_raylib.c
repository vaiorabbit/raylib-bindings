...
// - [Experimental] May contain incorrect codes.
...
struct RClass* cRaylibModelSkeleton;
static const struct mrb_data_type mrb_raylib_struct_ModelSkeleton = {
    "ModelSkeleton", mrb_free
};
...
static mrb_value mrb_raylib_Vector2_initialize(mrb_state* mrb, mrb_value self)
{
    ...
    if (argc != 0 && argc != 2) {
        mrb_raisef(mrb, E_ARGUMENT_ERROR, "wrong number of arguments (given %i, expected 0 or 2)", argc);
    }
...
static mrb_value mrb_raylib_Matrix_initialize(mrb_state* mrb, mrb_value self)
{
    mrb_int argc = mrb_get_argc(mrb);
    if (argc != 0 && argc != 16) {
        mrb_raisef(mrb, E_ARGUMENT_ERROR, "wrong number of arguments (given %i, expected 0 or 16)", argc);
    }
...
static mrb_value mrb_raylib_NPatchInfo_initialize(mrb_state* mrb, mrb_value self)
{
    mrb_int argc = mrb_get_argc(mrb);
    if (argc != 0 && argc != 6) {
        mrb_raisef(mrb, E_ARGUMENT_ERROR, "wrong number of arguments (given %i, expected 0 or 6)", argc);
    }
...
static mrb_value mrb_raylib_Mesh_initialize(mrb_state* mrb, mrb_value self)
{
    ...
    if (argc == 0) {
        ...
        instance->boneCount = mrb_as_int(mrb, argv[9]);
        instance->boneIndices = DATA_PTR(argv[10]);
        instance->boneWeights = DATA_PTR(argv[11]);
        instance->animVertices = DATA_PTR(argv[12]);
        instance->animNormals = DATA_PTR(argv[13]);
        instance->vaoId = mrb_as_int(mrb, argv[14]);
        instance->vboId = DATA_PTR(argv[15]);
    }
...
static mrb_value mrb_raylib_Mesh_boneCount_get(mrb_state* mrb, mrb_value self)
{
    Mesh* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_Mesh, Mesh);
...
static mrb_value mrb_raylib_Mesh_boneCount_set(mrb_state* mrb, mrb_value self)
{
    Mesh* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_Mesh, Mesh);
...
static mrb_value mrb_raylib_Mesh_boneIndices_get(mrb_state* mrb, mrb_value self)
{
    Mesh* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_Mesh, Mesh);

    return mrb_cptr_value(mrb, instance->boneIndices);
}

static mrb_value mrb_raylib_Mesh_boneIndices_set(mrb_state* mrb, mrb_value self)
{
    Mesh* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_Mesh, Mesh);

    mrb_value argv;
    mrb_get_args(mrb, "o", &argv);
    instance->boneIndices = DATA_PTR(argv);
...
static mrb_value mrb_raylib_ModelSkeleton_initialize(mrb_state* mrb, mrb_value self)
{
    mrb_int argc = mrb_get_argc(mrb);
    if (argc != 0 && argc != 3) {
        mrb_raisef(mrb, E_ARGUMENT_ERROR, "wrong number of arguments (given %i, expected 0 or 3)", argc);
    }
    ModelSkeleton* instance = (ModelSkeleton*)mrb_malloc(mrb, sizeof(ModelSkeleton));

    if (argc == 0) {
        memset(instance, 0, sizeof(ModelSkeleton));
    }
    else {
        mrb_value argv[3];
        void* ptrs[3] = { &argv[0], &argv[1], &argv[2], };
        ...
        instance->bones = DATA_PTR(argv[1]);
        instance->bindPose = DATA_PTR(argv[2]);
    }
    mrb_data_init(self, instance, &mrb_raylib_struct_ModelSkeleton);

    return self;
}

static mrb_value mrb_raylib_ModelSkeleton_class_size(mrb_state* mrb, mrb_value self)
{
    return mrb_int_value(mrb, sizeof(ModelSkeleton));
}

static mrb_value mrb_raylib_ModelSkeleton_boneCount_get(mrb_state* mrb, mrb_value self)
{
    ModelSkeleton* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_ModelSkeleton, ModelSkeleton);

    return mrb_int_value(mrb, instance->boneCount);
}

static mrb_value mrb_raylib_ModelSkeleton_boneCount_set(mrb_state* mrb, mrb_value self)
{
    ModelSkeleton* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_ModelSkeleton, ModelSkeleton);
...
static mrb_value mrb_raylib_ModelSkeleton_bones_get(mrb_state* mrb, mrb_value self)
{
    ModelSkeleton* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_ModelSkeleton, ModelSkeleton);
...
static mrb_value mrb_raylib_ModelSkeleton_bones_set(mrb_state* mrb, mrb_value self)
{
    ModelSkeleton* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_ModelSkeleton, ModelSkeleton);
...
static mrb_value mrb_raylib_ModelSkeleton_bindPose_get(mrb_state* mrb, mrb_value self)
{
    ModelSkeleton* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_ModelSkeleton, ModelSkeleton);
...
static mrb_value mrb_raylib_ModelSkeleton_bindPose_set(mrb_state* mrb, mrb_value self)
{
    ModelSkeleton* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_ModelSkeleton, ModelSkeleton);
...
static mrb_value mrb_raylib_Model_initialize(mrb_state* mrb, mrb_value self)
{
    mrb_int argc = mrb_get_argc(mrb);
    if (argc != 0 && argc != 9) {
        mrb_raisef(mrb, E_ARGUMENT_ERROR, "wrong number of arguments (given %i, expected 0 or 9)", argc);
    }
    ...
    if (argc == 0) {
        ...
        instance->skeleton = *(ModelSkeleton*)DATA_GET_PTR(mrb, argv[6], &mrb_raylib_struct_ModelSkeleton, ModelSkeleton);
        instance->currentPose = DATA_PTR(argv[7]);
        instance->boneMatrices = DATA_PTR(argv[8]);
    }
...
static mrb_value mrb_raylib_Model_skeleton_get(mrb_state* mrb, mrb_value self)
{
    Model* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_Model, Model);

    return mrb_obj_value(&instance->skeleton);
}

static mrb_value mrb_raylib_Model_skeleton_set(mrb_state* mrb, mrb_value self)
{
    Model* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_Model, Model);

    mrb_value argv;
    mrb_get_args(mrb, "o", &argv);
    instance->skeleton = *(ModelSkeleton*)DATA_GET_PTR(mrb, argv, &mrb_raylib_struct_ModelSkeleton, ModelSkeleton);

    return mrb_nil_value();
}

static mrb_value mrb_raylib_Model_currentPose_get(mrb_state* mrb, mrb_value self)
{
    Model* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_Model, Model);

    return mrb_cptr_value(mrb, instance->currentPose);
}

static mrb_value mrb_raylib_Model_currentPose_set(mrb_state* mrb, mrb_value self)
{
    Model* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_Model, Model);

    mrb_value argv;
    mrb_get_args(mrb, "o", &argv);
    instance->currentPose = DATA_PTR(argv);

    return mrb_nil_value();
}

static mrb_value mrb_raylib_Model_boneMatrices_get(mrb_state* mrb, mrb_value self)
{
    Model* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_Model, Model);

    return mrb_cptr_value(mrb, instance->boneMatrices);
}

static mrb_value mrb_raylib_Model_boneMatrices_set(mrb_state* mrb, mrb_value self)
{
    Model* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_Model, Model);

    mrb_value argv;
    mrb_get_args(mrb, "o", &argv);
    instance->boneMatrices = DATA_PTR(argv);
...
static mrb_value mrb_raylib_ModelAnimation_initialize(mrb_state* mrb, mrb_value self)
{
    ...
    if (argc == 0) {
        ...
        mrb_get_args_a(mrb, "oooo", ptrs);
        strncpy(instance->name, mrb_string_cstr(mrb, argv[0]), sizeof(char) * 32);
        instance->boneCount = mrb_as_int(mrb, argv[1]);
        instance->keyframeCount = mrb_as_int(mrb, argv[2]);
        instance->keyframePoses = DATA_PTR(argv[3]);
    }
...
static mrb_value mrb_raylib_ModelAnimation_keyframeCount_get(mrb_state* mrb, mrb_value self)
{
    ModelAnimation* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_ModelAnimation, ModelAnimation);

    return mrb_int_value(mrb, instance->keyframeCount);
}

static mrb_value mrb_raylib_ModelAnimation_keyframeCount_set(mrb_state* mrb, mrb_value self)
{
    ModelAnimation* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_ModelAnimation, ModelAnimation);

    mrb_value argv;
    mrb_get_args(mrb, "o", &argv);
    instance->keyframeCount = mrb_as_int(mrb, argv);

    return mrb_nil_value();
}

static mrb_value mrb_raylib_ModelAnimation_keyframePoses_get(mrb_state* mrb, mrb_value self)
{
    ModelAnimation* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_ModelAnimation, ModelAnimation);

    return mrb_cptr_value(mrb, instance->keyframePoses);
}

static mrb_value mrb_raylib_ModelAnimation_keyframePoses_set(mrb_state* mrb, mrb_value self)
{
    ModelAnimation* instance = DATA_GET_PTR(mrb, self, &mrb_raylib_struct_ModelAnimation, ModelAnimation);

    mrb_value argv;
    mrb_get_args(mrb, "o", &argv);
    instance->keyframePoses = DATA_PTR(argv);
...
static mrb_value mrb_raylib_VrStereoConfig_initialize(mrb_state* mrb, mrb_value self)
{
    mrb_int argc = mrb_get_argc(mrb);
    if (argc != 0 && argc != 8) {
        mrb_raisef(mrb, E_ARGUMENT_ERROR, "wrong number of arguments (given %i, expected 0 or 8)", argc);
    }
...
static mrb_value mrb_raylib_FilePathList_initialize(mrb_state* mrb, mrb_value self)
{
    ...
    if (argc == 0) {
        ...
        void* ptrs[2] = { &argv[0], &argv[1], };
        mrb_get_args_a(mrb, "oo", ptrs);
        instance->count = mrb_as_int(mrb, argv[0]);
        instance->paths = DATA_PTR(argv[1]);
    }
...
static mrb_value mrb_raylib_GetClipboardImage(mrb_state* mrb, mrb_value self)
{
    Image* retval = (Image*)mrb_malloc(mrb, sizeof(Image));
    *retval = GetClipboardImage();
...
static mrb_value mrb_raylib_IsShaderValid(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    bool retval = IsShaderValid(shader);
...
static mrb_value mrb_raylib_GetScreenToWorldRay(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[2];
    void* ptrs[2] = { &argv[0], &argv[1], };
    mrb_get_args_a(mrb, "oo", ptrs);
    ...
    *retval = GetScreenToWorldRay(position, camera);

    return mrb_obj_value(Data_Wrap_Struct(mrb, cRaylibRay, &mrb_raylib_struct_Ray, retval));
}

static mrb_value mrb_raylib_GetScreenToWorldRayEx(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[4];
    void* ptrs[4] = { &argv[0], &argv[1], &argv[2], &argv[3], };
    mrb_get_args_a(mrb, "oooo", ptrs);
    ...
    Ray* retval = (Ray*)mrb_malloc(mrb, sizeof(Ray));
    *retval = GetScreenToWorldRayEx(position, camera, width, height);
...
static mrb_value mrb_raylib_FileRename(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[2];
    void* ptrs[2] = { &argv[0], &argv[1], };
    mrb_get_args_a(mrb, "oo", ptrs);
    const char * fileName = RSTRING_PTR(argv[0]);
    const char * fileRename = RSTRING_PTR(argv[1]);

    int retval = FileRename(fileName, fileRename);

    return mrb_int_value(mrb, retval);
}

static mrb_value mrb_raylib_FileRemove(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    int retval = FileRemove(fileName);

    return mrb_int_value(mrb, retval);
}

static mrb_value mrb_raylib_FileCopy(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[2];
    void* ptrs[2] = { &argv[0], &argv[1], };
    mrb_get_args_a(mrb, "oo", ptrs);
    const char * srcPath = RSTRING_PTR(argv[0]);
    const char * dstPath = RSTRING_PTR(argv[1]);

    int retval = FileCopy(srcPath, dstPath);

    return mrb_int_value(mrb, retval);
}

static mrb_value mrb_raylib_FileMove(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[2];
    void* ptrs[2] = { &argv[0], &argv[1], };
    mrb_get_args_a(mrb, "oo", ptrs);
    ...
    int retval = FileMove(srcPath, dstPath);

    return mrb_int_value(mrb, retval);
}

static mrb_value mrb_raylib_FileTextReplace(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[3];
    void* ptrs[3] = { &argv[0], &argv[1], &argv[2], };
    mrb_get_args_a(mrb, "ooo", ptrs);
    const char * fileName = RSTRING_PTR(argv[0]);
    const char * search = RSTRING_PTR(argv[1]);
    const char * replacement = RSTRING_PTR(argv[2]);

    int retval = FileTextReplace(fileName, search, replacement);

    return mrb_int_value(mrb, retval);
}

static mrb_value mrb_raylib_FileTextFindIndex(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[2];
    void* ptrs[2] = { &argv[0], &argv[1], };
    mrb_get_args_a(mrb, "oo", ptrs);
    ...
    int retval = FileTextFindIndex(fileName, search);
...
static mrb_value mrb_raylib_MakeDirectory(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    int retval = MakeDirectory(dirPath);
...
static mrb_value mrb_raylib_ChangeDirectory(mrb_state* mrb, mrb_value self)
{
    ...
    int retval = ChangeDirectory(dirPath);
...
static mrb_value mrb_raylib_IsPathDirectory(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    bool retval = IsPathDirectory(path);

    return retval ? mrb_true_value() : mrb_false_value();
}

static mrb_value mrb_raylib_IsPathAbsolute(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    bool retval = IsPathAbsolute(path);

    return retval ? mrb_true_value() : mrb_false_value();
}

static mrb_value mrb_raylib_IsFileNameValid(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    bool retval = IsFileNameValid(fileName);
...
static mrb_value mrb_raylib_GetDirectoryFileCount(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    unsigned int retval = GetDirectoryFileCount(dirPath);

    return mrb_int_value(mrb, retval);
}

static mrb_value mrb_raylib_GetDirectoryFileCountEx(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[3];
    void* ptrs[3] = { &argv[0], &argv[1], &argv[2], };
    mrb_get_args_a(mrb, "ooo", ptrs);
    ...
    unsigned int retval = GetDirectoryFileCountEx(basePath, filter, scanSubdirs);
...
static mrb_value mrb_raylib_DecodeDataBase64(mrb_state* mrb, mrb_value self)
{
    ...
    unsigned char * retval = DecodeDataBase64(text, outputSize);

    return mrb_cptr_value(mrb, retval);
}

static mrb_value mrb_raylib_ComputeCRC32(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[2];
    void* ptrs[2] = { &argv[0], &argv[1], };
    mrb_get_args_a(mrb, "oo", ptrs);
    ...
    unsigned int retval = ComputeCRC32(data, dataSize);

    return mrb_int_value(mrb, retval);
}

static mrb_value mrb_raylib_ComputeMD5(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[2];
    void* ptrs[2] = { &argv[0], &argv[1], };
    mrb_get_args_a(mrb, "oo", ptrs);
    ...
    unsigned int * retval = ComputeMD5(data, dataSize);

    return mrb_cptr_value(mrb, retval);
}

static mrb_value mrb_raylib_ComputeSHA1(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[2];
    void* ptrs[2] = { &argv[0], &argv[1], };
    mrb_get_args_a(mrb, "oo", ptrs);
    ...
    unsigned int * retval = ComputeSHA1(data, dataSize);

    return mrb_cptr_value(mrb, retval);
}

static mrb_value mrb_raylib_ComputeSHA256(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[2];
    void* ptrs[2] = { &argv[0], &argv[1], };
    mrb_get_args_a(mrb, "oo", ptrs);
    ...
    unsigned int * retval = ComputeSHA256(data, dataSize);
...
static mrb_value mrb_raylib_GetKeyName(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    const char * retval = GetKeyName(key);
...
static mrb_value mrb_raylib_SetGamepadVibration(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[4];
    void* ptrs[4] = { &argv[0], &argv[1], &argv[2], &argv[3], };
    mrb_get_args_a(mrb, "oooo", ptrs);
    int gamepad = mrb_as_int(mrb, argv[0]);
    float leftMotor = mrb_as_float(mrb, argv[1]);
    float rightMotor = mrb_as_float(mrb, argv[2]);
    float duration = mrb_as_float(mrb, argv[3]);
...
static mrb_value mrb_raylib_GetShapesTexture(mrb_state* mrb, mrb_value self)
{
    Texture2D* retval = (Texture2D*)mrb_malloc(mrb, sizeof(Texture2D));
    *retval = GetShapesTexture();

    return mrb_obj_value(Data_Wrap_Struct(mrb, cRaylibTexture, &mrb_raylib_struct_Texture, retval));
}

static mrb_value mrb_raylib_GetShapesTextureRectangle(mrb_state* mrb, mrb_value self)
{
    Rectangle* retval = (Rectangle*)mrb_malloc(mrb, sizeof(Rectangle));
    *retval = GetShapesTextureRectangle();
...
static mrb_value mrb_raylib_DrawLineStrip(mrb_state* mrb, mrb_value self)
{
    ...
    void* ptrs[3] = { &argv[0], &argv[1], &argv[2], };
    mrb_get_args_a(mrb, "ooo", ptrs);
    const Vector2 * points = DATA_PTR(argv[0]);
...
static mrb_value mrb_raylib_DrawLineDashed(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[5];
    void* ptrs[5] = { &argv[0], &argv[1], &argv[2], &argv[3], &argv[4], };
    mrb_get_args_a(mrb, "ooooo", ptrs);
    Vector2 startPos = *(Vector2*)DATA_GET_PTR(mrb, argv[0], &mrb_raylib_struct_Vector2, Vector2);;
    Vector2 endPos = *(Vector2*)DATA_GET_PTR(mrb, argv[1], &mrb_raylib_struct_Vector2, Vector2);;
    int dashSize = mrb_as_int(mrb, argv[2]);
    int spaceSize = mrb_as_int(mrb, argv[3]);
    Color color = *(Color*)DATA_GET_PTR(mrb, argv[4], &mrb_raylib_struct_Color, Color);;
...
static mrb_value mrb_raylib_DrawTriangleGradient(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[6];
    void* ptrs[6] = { &argv[0], &argv[1], &argv[2], &argv[3], &argv[4], &argv[5], };
    mrb_get_args_a(mrb, "oooooo", ptrs);
    ...
    Vector2 v2 = *(Vector2*)DATA_GET_PTR(mrb, argv[1], &mrb_raylib_struct_Vector2, Vector2);;
    Vector2 v3 = *(Vector2*)DATA_GET_PTR(mrb, argv[2], &mrb_raylib_struct_Vector2, Vector2);;
    Color c1 = *(Color*)DATA_GET_PTR(mrb, argv[3], &mrb_raylib_struct_Color, Color);;
    Color c2 = *(Color*)DATA_GET_PTR(mrb, argv[4], &mrb_raylib_struct_Color, Color);;
    Color c3 = *(Color*)DATA_GET_PTR(mrb, argv[5], &mrb_raylib_struct_Color, Color);;
...
static mrb_value mrb_raylib_DrawRectangleGradientV(mrb_state* mrb, mrb_value self)
{
    ...
    int width = mrb_as_int(mrb, argv[2]);
    int height = mrb_as_int(mrb, argv[3]);
    Color top = *(Color*)DATA_GET_PTR(mrb, argv[4], &mrb_raylib_struct_Color, Color);;
    Color bottom = *(Color*)DATA_GET_PTR(mrb, argv[5], &mrb_raylib_struct_Color, Color);;
...
static mrb_value mrb_raylib_DrawRectangleGradientH(mrb_state* mrb, mrb_value self)
{
    ...
    int width = mrb_as_int(mrb, argv[2]);
    int height = mrb_as_int(mrb, argv[3]);
    Color left = *(Color*)DATA_GET_PTR(mrb, argv[4], &mrb_raylib_struct_Color, Color);;
    Color right = *(Color*)DATA_GET_PTR(mrb, argv[5], &mrb_raylib_struct_Color, Color);;
...
static mrb_value mrb_raylib_DrawRectangleLinesEx(mrb_state* mrb, mrb_value self)
{
    ...
    mrb_get_args_a(mrb, "ooo", ptrs);
    Rectangle rec = *(Rectangle*)DATA_GET_PTR(mrb, argv[0], &mrb_raylib_struct_Rectangle, Rectangle);;
    float thick = mrb_as_float(mrb, argv[1]);
    Color color = *(Color*)DATA_GET_PTR(mrb, argv[2], &mrb_raylib_struct_Color, Color);;
...
static mrb_value mrb_raylib_DrawCircleGradient(mrb_state* mrb, mrb_value self)
{
    ...
    Vector2 center = *(Vector2*)DATA_GET_PTR(mrb, argv[0], &mrb_raylib_struct_Vector2, Vector2);;
    float radius = mrb_as_float(mrb, argv[1]);
    Color inner = *(Color*)DATA_GET_PTR(mrb, argv[2], &mrb_raylib_struct_Color, Color);;
    Color outer = *(Color*)DATA_GET_PTR(mrb, argv[3], &mrb_raylib_struct_Color, Color);;
...
static mrb_value mrb_raylib_DrawCircleLinesEx(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[4];
    void* ptrs[4] = { &argv[0], &argv[1], &argv[2], &argv[3], };
    mrb_get_args_a(mrb, "oooo", ptrs);
...
static mrb_value mrb_raylib_DrawEllipseV(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[4];
    void* ptrs[4] = { &argv[0], &argv[1], &argv[2], &argv[3], };
    mrb_get_args_a(mrb, "oooo", ptrs);
...
static mrb_value mrb_raylib_DrawEllipseLinesV(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[4];
    void* ptrs[4] = { &argv[0], &argv[1], &argv[2], &argv[3], };
    mrb_get_args_a(mrb, "oooo", ptrs);
...
static mrb_value mrb_raylib_GetSplinePointBezierQuadratic(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[4];
    void* ptrs[4] = { &argv[0], &argv[1], &argv[2], &argv[3], };
    mrb_get_args_a(mrb, "oooo", ptrs);
    ...
    Vector2* retval = (Vector2*)mrb_malloc(mrb, sizeof(Vector2));
    *retval = GetSplinePointBezierQuadratic(p1, c2, p3, t);
...
static mrb_value mrb_raylib_CheckCollisionCircleLine(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[4];
    void* ptrs[4] = { &argv[0], &argv[1], &argv[2], &argv[3], };
    mrb_get_args_a(mrb, "oooo", ptrs);
    Vector2 center = *(Vector2*)DATA_GET_PTR(mrb, argv[0], &mrb_raylib_struct_Vector2, Vector2);;
    float radius = mrb_as_float(mrb, argv[1]);
    Vector2 p1 = *(Vector2*)DATA_GET_PTR(mrb, argv[2], &mrb_raylib_struct_Vector2, Vector2);;
    Vector2 p2 = *(Vector2*)DATA_GET_PTR(mrb, argv[3], &mrb_raylib_struct_Vector2, Vector2);;

    bool retval = CheckCollisionCircleLine(center, radius, p1, p2);
...
static mrb_value mrb_raylib_CheckCollisionPointPoly(mrb_state* mrb, mrb_value self)
{
    ...
    mrb_get_args_a(mrb, "ooo", ptrs);
    Vector2 point = *(Vector2*)DATA_GET_PTR(mrb, argv[0], &mrb_raylib_struct_Vector2, Vector2);;
    const Vector2 * points = DATA_PTR(argv[1]);
...
static mrb_value mrb_raylib_LoadImageAnimFromMemory(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[4];
    void* ptrs[4] = { &argv[0], &argv[1], &argv[2], &argv[3], };
    mrb_get_args_a(mrb, "oooo", ptrs);
    ...
    int dataSize = mrb_as_int(mrb, argv[2]);
    int * frames = DATA_PTR(argv[3]);

    Image* retval = (Image*)mrb_malloc(mrb, sizeof(Image));
    *retval = LoadImageAnimFromMemory(fileType, fileData, dataSize, frames);
...
static mrb_value mrb_raylib_IsImageValid(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    bool retval = IsImageValid(image);
...
static mrb_value mrb_raylib_ImageFromChannel(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[2];
    void* ptrs[2] = { &argv[0], &argv[1], };
    mrb_get_args_a(mrb, "oo", ptrs);
    Image image = *(Image*)DATA_GET_PTR(mrb, argv[0], &mrb_raylib_struct_Image, Image);;
    int selectedChannel = mrb_as_int(mrb, argv[1]);

    Image* retval = (Image*)mrb_malloc(mrb, sizeof(Image));
    *retval = ImageFromChannel(image, selectedChannel);
...
static mrb_value mrb_raylib_ImageKernelConvolution(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[3];
    void* ptrs[3] = { &argv[0], &argv[1], &argv[2], };
    mrb_get_args_a(mrb, "ooo", ptrs);
    Image * image = DATA_PTR(argv[0]);
    const float * kernel = DATA_PTR(argv[1]);
    int kernelSize = mrb_as_int(mrb, argv[2]);
...
static mrb_value mrb_raylib_ImageColorContrast(mrb_state* mrb, mrb_value self)
{
    ...
    mrb_get_args_a(mrb, "oo", ptrs);
    Image * image = DATA_PTR(argv[0]);
    int contrast = mrb_as_int(mrb, argv[1]);
...
static mrb_value mrb_raylib_ImageDrawLineEx(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[5];
    void* ptrs[5] = { &argv[0], &argv[1], &argv[2], &argv[3], &argv[4], };
    mrb_get_args_a(mrb, "ooooo", ptrs);
    ...
    Vector2 start = *(Vector2*)DATA_GET_PTR(mrb, argv[1], &mrb_raylib_struct_Vector2, Vector2);;
    Vector2 end = *(Vector2*)DATA_GET_PTR(mrb, argv[2], &mrb_raylib_struct_Vector2, Vector2);;
    int thick = mrb_as_int(mrb, argv[3]);
    Color color = *(Color*)DATA_GET_PTR(mrb, argv[4], &mrb_raylib_struct_Color, Color);;
...
static mrb_value mrb_raylib_ImageDrawLineStrip(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[4];
    void* ptrs[4] = { &argv[0], &argv[1], &argv[2], &argv[3], };
    mrb_get_args_a(mrb, "oooo", ptrs);
    ...
    ImageDrawLineStrip(dst, points, pointCount, color);

    return mrb_nil_value();
}

static mrb_value mrb_raylib_ImageDrawTriangle(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[5];
    void* ptrs[5] = { &argv[0], &argv[1], &argv[2], &argv[3], &argv[4], };
    mrb_get_args_a(mrb, "ooooo", ptrs);
    Image * dst = DATA_PTR(argv[0]);
    Vector2 v1 = *(Vector2*)DATA_GET_PTR(mrb, argv[1], &mrb_raylib_struct_Vector2, Vector2);;
    Vector2 v2 = *(Vector2*)DATA_GET_PTR(mrb, argv[2], &mrb_raylib_struct_Vector2, Vector2);;
    Vector2 v3 = *(Vector2*)DATA_GET_PTR(mrb, argv[3], &mrb_raylib_struct_Vector2, Vector2);;
    Color color = *(Color*)DATA_GET_PTR(mrb, argv[4], &mrb_raylib_struct_Color, Color);;
...
static mrb_value mrb_raylib_ImageDrawTriangleGradient(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[7];
    void* ptrs[7] = { &argv[0], &argv[1], &argv[2], &argv[3], &argv[4], &argv[5], &argv[6], };
    mrb_get_args_a(mrb, "ooooooo", ptrs);
    ...
    Vector2 v2 = *(Vector2*)DATA_GET_PTR(mrb, argv[2], &mrb_raylib_struct_Vector2, Vector2);;
    Vector2 v3 = *(Vector2*)DATA_GET_PTR(mrb, argv[3], &mrb_raylib_struct_Vector2, Vector2);;
    Color c1 = *(Color*)DATA_GET_PTR(mrb, argv[4], &mrb_raylib_struct_Color, Color);;
    Color c2 = *(Color*)DATA_GET_PTR(mrb, argv[5], &mrb_raylib_struct_Color, Color);;
    Color c3 = *(Color*)DATA_GET_PTR(mrb, argv[6], &mrb_raylib_struct_Color, Color);;
...
static mrb_value mrb_raylib_ImageDrawTriangleLines(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[5];
    void* ptrs[5] = { &argv[0], &argv[1], &argv[2], &argv[3], &argv[4], };
    mrb_get_args_a(mrb, "ooooo", ptrs);
...
static mrb_value mrb_raylib_ImageDrawTriangleFan(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[4];
    void* ptrs[4] = { &argv[0], &argv[1], &argv[2], &argv[3], };
    mrb_get_args_a(mrb, "oooo", ptrs);
...
static mrb_value mrb_raylib_ImageDrawTriangleStrip(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[4];
    void* ptrs[4] = { &argv[0], &argv[1], &argv[2], &argv[3], };
    mrb_get_args_a(mrb, "oooo", ptrs);
...
static mrb_value mrb_raylib_ImageDrawRectanglePro(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[5];
    void* ptrs[5] = { &argv[0], &argv[1], &argv[2], &argv[3], &argv[4], };
    mrb_get_args_a(mrb, "ooooo", ptrs);
    Image * dst = DATA_PTR(argv[0]);
    Rectangle rec = *(Rectangle*)DATA_GET_PTR(mrb, argv[1], &mrb_raylib_struct_Rectangle, Rectangle);;
    Vector2 origin = *(Vector2*)DATA_GET_PTR(mrb, argv[2], &mrb_raylib_struct_Vector2, Vector2);;
    float rotation = mrb_as_float(mrb, argv[3]);
    Color color = *(Color*)DATA_GET_PTR(mrb, argv[4], &mrb_raylib_struct_Color, Color);;

    ImageDrawRectanglePro(dst, rec, origin, rotation, color);
...
static mrb_value mrb_raylib_ImageDrawRectangleLinesEx(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[4];
    void* ptrs[4] = { &argv[0], &argv[1], &argv[2], &argv[3], };
    mrb_get_args_a(mrb, "oooo", ptrs);
...
static mrb_value mrb_raylib_ImageDrawRectangleGradientEx(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[6];
    void* ptrs[6] = { &argv[0], &argv[1], &argv[2], &argv[3], &argv[4], &argv[5], };
    mrb_get_args_a(mrb, "oooooo", ptrs);
    Image * dst = DATA_PTR(argv[0]);
    Rectangle rec = *(Rectangle*)DATA_GET_PTR(mrb, argv[1], &mrb_raylib_struct_Rectangle, Rectangle);;
    Color col1 = *(Color*)DATA_GET_PTR(mrb, argv[2], &mrb_raylib_struct_Color, Color);;
    Color col2 = *(Color*)DATA_GET_PTR(mrb, argv[3], &mrb_raylib_struct_Color, Color);;
    Color col3 = *(Color*)DATA_GET_PTR(mrb, argv[4], &mrb_raylib_struct_Color, Color);;
    Color col4 = *(Color*)DATA_GET_PTR(mrb, argv[5], &mrb_raylib_struct_Color, Color);;

    ImageDrawRectangleGradientEx(dst, rec, col1, col2, col3, col4);
...
static mrb_value mrb_raylib_ImageDrawCircleGradient(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[5];
    void* ptrs[5] = { &argv[0], &argv[1], &argv[2], &argv[3], &argv[4], };
    mrb_get_args_a(mrb, "ooooo", ptrs);
    ...
    ImageDrawCircleGradient(dst, center, radius, inner, outer);

    return mrb_nil_value();
}

static mrb_value mrb_raylib_ImageDrawImage(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[5];
    void* ptrs[5] = { &argv[0], &argv[1], &argv[2], &argv[3], &argv[4], };
    mrb_get_args_a(mrb, "ooooo", ptrs);
    ...
    ImageDrawImage(dst, src, posX, posY, tint);

    return mrb_nil_value();
}

static mrb_value mrb_raylib_ImageDrawImageEx(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[6];
    void* ptrs[6] = { &argv[0], &argv[1], &argv[2], &argv[3], &argv[4], &argv[5], };
    mrb_get_args_a(mrb, "oooooo", ptrs);
    ...
    ImageDrawImageEx(dst, src, position, rotation, scale, tint);

    return mrb_nil_value();
}

static mrb_value mrb_raylib_ImageDrawImageRec(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[5];
    void* ptrs[5] = { &argv[0], &argv[1], &argv[2], &argv[3], &argv[4], };
    mrb_get_args_a(mrb, "ooooo", ptrs);
    ...
    ImageDrawImageRec(dst, src, srcRec, position, tint);

    return mrb_nil_value();
}

static mrb_value mrb_raylib_ImageDrawImagePro(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[7];
    void* ptrs[7] = { &argv[0], &argv[1], &argv[2], &argv[3], &argv[4], &argv[5], &argv[6], };
    mrb_get_args_a(mrb, "ooooooo", ptrs);
    ...
    Vector2 origin = *(Vector2*)DATA_GET_PTR(mrb, argv[4], &mrb_raylib_struct_Vector2, Vector2);;
    float rotation = mrb_as_float(mrb, argv[5]);
...
static mrb_value mrb_raylib_ImageDrawTextPro(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[9];
    void* ptrs[9] = { &argv[0], &argv[1], &argv[2], &argv[3], &argv[4], &argv[5], &argv[6], &argv[7], &argv[8], };
    mrb_get_args_a(mrb, "ooooooooo", ptrs);
    ...
    Vector2 origin = *(Vector2*)DATA_GET_PTR(mrb, argv[4], &mrb_raylib_struct_Vector2, Vector2);;
    float rotation = mrb_as_float(mrb, argv[5]);
    float fontSize = mrb_as_float(mrb, argv[6]);
    float spacing = mrb_as_float(mrb, argv[7]);
    Color tint = *(Color*)DATA_GET_PTR(mrb, argv[8], &mrb_raylib_struct_Color, Color);;

    ImageDrawTextPro(dst, font, text, position, origin, rotation, fontSize, spacing, tint);
...
static mrb_value mrb_raylib_IsTextureValid(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    bool retval = IsTextureValid(texture);
...
static mrb_value mrb_raylib_IsRenderTextureValid(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    bool retval = IsRenderTextureValid(target);
...
static mrb_value mrb_raylib_DrawTextureRec(mrb_state* mrb, mrb_value self)
{
    ...
    DrawTextureRec(texture, rec, position, tint);
...
static mrb_value mrb_raylib_DrawTexturePro(mrb_state* mrb, mrb_value self)
{
    ...
    mrb_get_args_a(mrb, "oooooo", ptrs);
    Texture2D texture = *(Texture2D*)DATA_GET_PTR(mrb, argv[0], &mrb_raylib_struct_Texture, Texture2D);;
    Rectangle srcrec = *(Rectangle*)DATA_GET_PTR(mrb, argv[1], &mrb_raylib_struct_Rectangle, Rectangle);;
    Rectangle dstrec = *(Rectangle*)DATA_GET_PTR(mrb, argv[2], &mrb_raylib_struct_Rectangle, Rectangle);;
...
static mrb_value mrb_raylib_DrawTextureNPatch(mrb_state* mrb, mrb_value self)
{
    ...
    DrawTextureNPatch(texture, nPatchInfo, dstrec, origin, rotation, tint);

    return mrb_nil_value();
}

static mrb_value mrb_raylib_ColorIsEqual(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[2];
    void* ptrs[2] = { &argv[0], &argv[1], };
    mrb_get_args_a(mrb, "oo", ptrs);
    Color col1 = *(Color*)DATA_GET_PTR(mrb, argv[0], &mrb_raylib_struct_Color, Color);;
    Color col2 = *(Color*)DATA_GET_PTR(mrb, argv[1], &mrb_raylib_struct_Color, Color);;

    bool retval = ColorIsEqual(col1, col2);
...
static mrb_value mrb_raylib_ColorLerp(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[3];
    void* ptrs[3] = { &argv[0], &argv[1], &argv[2], };
    mrb_get_args_a(mrb, "ooo", ptrs);
    Color color1 = *(Color*)DATA_GET_PTR(mrb, argv[0], &mrb_raylib_struct_Color, Color);;
    Color color2 = *(Color*)DATA_GET_PTR(mrb, argv[1], &mrb_raylib_struct_Color, Color);;
    float factor = mrb_as_float(mrb, argv[2]);

    Color* retval = (Color*)mrb_malloc(mrb, sizeof(Color));
    *retval = ColorLerp(color1, color2, factor);
...
static mrb_value mrb_raylib_GetPixelColor(mrb_state* mrb, mrb_value self)
{
    ...
    void* ptrs[2] = { &argv[0], &argv[1], };
    mrb_get_args_a(mrb, "oo", ptrs);
    const void * srcPtr = DATA_PTR(argv[0]);
...
static mrb_value mrb_raylib_LoadFontEx(mrb_state* mrb, mrb_value self)
{
    ...
    const char * fileName = RSTRING_PTR(argv[0]);
    int fontSize = mrb_as_int(mrb, argv[1]);
    const int * codepoints = DATA_PTR(argv[2]);
...
static mrb_value mrb_raylib_LoadFontFromMemory(mrb_state* mrb, mrb_value self)
{
    ...
    const int * codepoints = DATA_PTR(argv[4]);
...
static mrb_value mrb_raylib_IsFontValid(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
...
static mrb_value mrb_raylib_LoadFontData(mrb_state* mrb, mrb_value self)
{
    ...
    const int * codepoints = DATA_PTR(argv[3]);
    int codepointCount = mrb_as_int(mrb, argv[4]);
    int type = mrb_as_int(mrb, argv[5]);
    int * glyphCount = DATA_PTR(argv[6]);

    GlyphInfo * retval = LoadFontData(fileData, dataSize, fontSize, codepoints, codepointCount, type, glyphCount);
...
static mrb_value mrb_raylib_MeasureTextCodepoints(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[5];
    void* ptrs[5] = { &argv[0], &argv[1], &argv[2], &argv[3], &argv[4], };
    mrb_get_args_a(mrb, "ooooo", ptrs);
    ...
    Vector2* retval = (Vector2*)mrb_malloc(mrb, sizeof(Vector2));
    *retval = MeasureTextCodepoints(font, codepoints, length, fontSize, spacing);
...
static mrb_value mrb_raylib_LoadTextLines(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[2];
    void* ptrs[2] = { &argv[0], &argv[1], };
    mrb_get_args_a(mrb, "oo", ptrs);
    ...
    char ** retval = LoadTextLines(text, count);

    return mrb_cptr_value(mrb, retval);
}

static mrb_value mrb_raylib_UnloadTextLines(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[2];
    void* ptrs[2] = { &argv[0], &argv[1], };
    mrb_get_args_a(mrb, "oo", ptrs);
    char ** text = DATA_PTR(argv[0]);
    int lineCount = mrb_as_int(mrb, argv[1]);
...
static mrb_value mrb_raylib_TextRemoveSpaces(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    const char * retval = TextRemoveSpaces(text);

    return mrb_cptr_value(mrb, retval);
}

static mrb_value mrb_raylib_GetTextBetween(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[3];
    void* ptrs[3] = { &argv[0], &argv[1], &argv[2], };
    mrb_get_args_a(mrb, "ooo", ptrs);
    const char * text = RSTRING_PTR(argv[0]);
    const char * begin = RSTRING_PTR(argv[1]);
    const char * end = RSTRING_PTR(argv[2]);

    char * retval = GetTextBetween(text, begin, end);
...
static mrb_value mrb_raylib_TextReplace(mrb_state* mrb, mrb_value self)
{
    ...
    char * retval = TextReplace(text, search, replacement);

    return mrb_cptr_value(mrb, retval);
}

static mrb_value mrb_raylib_TextReplaceAlloc(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[3];
    void* ptrs[3] = { &argv[0], &argv[1], &argv[2], };
    mrb_get_args_a(mrb, "ooo", ptrs);
    ...
    char * retval = TextReplaceAlloc(text, search, replacement);

    return mrb_cptr_value(mrb, retval);
}

static mrb_value mrb_raylib_TextReplaceBetween(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[4];
    void* ptrs[4] = { &argv[0], &argv[1], &argv[2], &argv[3], };
    mrb_get_args_a(mrb, "oooo", ptrs);
    ...
    const char * begin = RSTRING_PTR(argv[1]);
    const char * end = RSTRING_PTR(argv[2]);
    const char * replacement = RSTRING_PTR(argv[3]);

    char * retval = TextReplaceBetween(text, begin, end, replacement);

    return mrb_cptr_value(mrb, retval);
}

static mrb_value mrb_raylib_TextReplaceBetweenAlloc(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[4];
    void* ptrs[4] = { &argv[0], &argv[1], &argv[2], &argv[3], };
    mrb_get_args_a(mrb, "oooo", ptrs);
    ...
    char * retval = TextReplaceBetweenAlloc(text, begin, end, replacement);
...
static mrb_value mrb_raylib_TextInsertAlloc(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[3];
    void* ptrs[3] = { &argv[0], &argv[1], &argv[2], };
    mrb_get_args_a(mrb, "ooo", ptrs);
    ...
    char * retval = TextInsertAlloc(text, insert, position);
...
static mrb_value mrb_raylib_TextJoin(mrb_state* mrb, mrb_value self)
{
    ...
    void* ptrs[3] = { &argv[0], &argv[1], &argv[2], };
    mrb_get_args_a(mrb, "ooo", ptrs);
    char ** textList = DATA_PTR(argv[0]);
    int count = mrb_as_int(mrb, argv[1]);
    const char * delimiter = RSTRING_PTR(argv[2]);

    char * retval = TextJoin(textList, count, delimiter);
...
static mrb_value mrb_raylib_TextSplit(mrb_state* mrb, mrb_value self)
{
    ...
    char ** retval = TextSplit(text, delimiter, count);
...
static mrb_value mrb_raylib_TextFindIndex(mrb_state* mrb, mrb_value self)
{
    ...
    int retval = TextFindIndex(text, search);
...
static mrb_value mrb_raylib_TextToPascal(mrb_state* mrb, mrb_value self)
{
    ...
    char * retval = TextToPascal(text);

    return mrb_cptr_value(mrb, retval);
}

static mrb_value mrb_raylib_TextToSnake(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    char * retval = TextToSnake(text);

    return mrb_cptr_value(mrb, retval);
}

static mrb_value mrb_raylib_TextToCamel(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
...
static mrb_value mrb_raylib_TextToFloat(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
...
static mrb_value mrb_raylib_DrawTriangleStrip3D(mrb_state* mrb, mrb_value self)
{
    ...
    void* ptrs[3] = { &argv[0], &argv[1], &argv[2], };
    mrb_get_args_a(mrb, "ooo", ptrs);
    const Vector3 * points = DATA_PTR(argv[0]);
    int pointCount = mrb_as_int(mrb, argv[1]);
    Color color = *(Color*)DATA_GET_PTR(mrb, argv[2], &mrb_raylib_struct_Color, Color);;
...
static mrb_value mrb_raylib_DrawCapsule(mrb_state* mrb, mrb_value self)
{
    ...
    Vector3 endPos = *(Vector3*)DATA_GET_PTR(mrb, argv[1], &mrb_raylib_struct_Vector3, Vector3);;
    float radius = mrb_as_float(mrb, argv[2]);
    int rings = mrb_as_int(mrb, argv[3]);
...
static mrb_value mrb_raylib_IsModelValid(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    bool retval = IsModelValid(model);
...
static mrb_value mrb_raylib_DrawBillboardRec(mrb_state* mrb, mrb_value self)
{
    ...
    DrawBillboardRec(camera, texture, rec, position, size, tint);
...
static mrb_value mrb_raylib_DrawBillboardPro(mrb_state* mrb, mrb_value self)
{
    ...
    DrawBillboardPro(camera, texture, rec, position, up, size, origin, rotation, tint);
...
static mrb_value mrb_raylib_ExportMeshAsCode(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[2];
    void* ptrs[2] = { &argv[0], &argv[1], };
    mrb_get_args_a(mrb, "oo", ptrs);
    ...
    bool retval = ExportMeshAsCode(mesh, fileName);
...
static mrb_value mrb_raylib_IsMaterialValid(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    bool retval = IsMaterialValid(material);
...
static mrb_value mrb_raylib_UpdateModelAnimation(mrb_state* mrb, mrb_value self)
{
    ...
    float frame = mrb_as_float(mrb, argv[2]);
...
static mrb_value mrb_raylib_UpdateModelAnimationEx(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[6];
    void* ptrs[6] = { &argv[0], &argv[1], &argv[2], &argv[3], &argv[4], &argv[5], };
    mrb_get_args_a(mrb, "oooooo", ptrs);
    Model model = *(Model*)DATA_GET_PTR(mrb, argv[0], &mrb_raylib_struct_Model, Model);;
    ModelAnimation animA = *(ModelAnimation*)DATA_GET_PTR(mrb, argv[1], &mrb_raylib_struct_ModelAnimation, ModelAnimation);;
    float frameA = mrb_as_float(mrb, argv[2]);
    ModelAnimation animB = *(ModelAnimation*)DATA_GET_PTR(mrb, argv[3], &mrb_raylib_struct_ModelAnimation, ModelAnimation);;
    float frameB = mrb_as_float(mrb, argv[4]);
    float blend = mrb_as_float(mrb, argv[5]);
...
static mrb_value mrb_raylib_IsWaveValid(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
...
static mrb_value mrb_raylib_IsSoundValid(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    bool retval = IsSoundValid(sound);
...
static mrb_value mrb_raylib_WaveCrop(mrb_state* mrb, mrb_value self)
{
    ...
    int initFrame = mrb_as_int(mrb, argv[1]);
    int finalFrame = mrb_as_int(mrb, argv[2]);
...
static mrb_value mrb_raylib_IsMusicValid(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    bool retval = IsMusicValid(music);
...
static mrb_value mrb_raylib_IsAudioStreamValid(mrb_state* mrb, mrb_value self)
{
    mrb_value argv[1];
    void* ptrs[1] = { &argv[0], };
    mrb_get_args_a(mrb, "o", ptrs);
    ...
    bool retval = IsAudioStreamValid(stream);
...
void mrb_raylib_module_init(mrb_state* mrb)
{
    ...
    mrb_define_const(mrb, mRaylib, "RAYLIB_VERSION_MAJOR", mrb_int_value(mrb, 6));
    mrb_define_const(mrb, mRaylib, "RAYLIB_VERSION_MINOR", mrb_int_value(mrb, 1));
    mrb_define_const(mrb, mRaylib, "RAYLIB_VERSION_PATCH", mrb_int_value(mrb, 0));
    mrb_define_const(mrb, mRaylib, "RAYLIB_VERSION", mrb_str_new_cstr_frozen(mrb, "6.1-dev"));
    ...
    mrb_define_const(mrb, mRaylib, "KEY_MENU", mrb_int_value(mrb, 5));
    ...
    mrb_define_const(mrb, mRaylib, "SHADER_LOC_VERTEX_BONEIDS", mrb_int_value(mrb, 26));
    mrb_define_const(mrb, mRaylib, "SHADER_LOC_VERTEX_BONEWEIGHTS", mrb_int_value(mrb, 27));
    mrb_define_const(mrb, mRaylib, "SHADER_LOC_MATRIX_BONETRANSFORMS", mrb_int_value(mrb, 28));
    mrb_define_const(mrb, mRaylib, "SHADER_LOC_VERTEX_INSTANCETRANSFORM", mrb_int_value(mrb, 29));
    ...
    mrb_define_const(mrb, mRaylib, "SHADER_UNIFORM_UINT", mrb_int_value(mrb, 8));
    mrb_define_const(mrb, mRaylib, "SHADER_UNIFORM_UIVEC2", mrb_int_value(mrb, 9));
    mrb_define_const(mrb, mRaylib, "SHADER_UNIFORM_UIVEC3", mrb_int_value(mrb, 10));
    mrb_define_const(mrb, mRaylib, "SHADER_UNIFORM_UIVEC4", mrb_int_value(mrb, 11));
    mrb_define_const(mrb, mRaylib, "SHADER_UNIFORM_SAMPLER2D", mrb_int_value(mrb, 12));
    ...
    mrb_define_method(mrb, cRaylibVector2, "initialize", mrb_raylib_Vector2_initialize, MRB_ARGS_OPT(2));
    ...
    mrb_define_method(mrb, cRaylibVector3, "initialize", mrb_raylib_Vector3_initialize, MRB_ARGS_OPT(3));
    ...
    mrb_define_method(mrb, cRaylibVector4, "initialize", mrb_raylib_Vector4_initialize, MRB_ARGS_OPT(4));
    ...
    mrb_define_method(mrb, cRaylibMatrix, "initialize", mrb_raylib_Matrix_initialize, MRB_ARGS_OPT(16));
    ...
    mrb_define_method(mrb, cRaylibColor, "initialize", mrb_raylib_Color_initialize, MRB_ARGS_OPT(4));
    ...
    mrb_define_method(mrb, cRaylibRectangle, "initialize", mrb_raylib_Rectangle_initialize, MRB_ARGS_OPT(4));
    ...
    mrb_define_method(mrb, cRaylibImage, "initialize", mrb_raylib_Image_initialize, MRB_ARGS_OPT(5));
    ...
    mrb_define_method(mrb, cRaylibTexture, "initialize", mrb_raylib_Texture_initialize, MRB_ARGS_OPT(5));
    ...
    mrb_define_method(mrb, cRaylibRenderTexture, "initialize", mrb_raylib_RenderTexture_initialize, MRB_ARGS_OPT(3));
    ...
    mrb_define_method(mrb, cRaylibNPatchInfo, "initialize", mrb_raylib_NPatchInfo_initialize, MRB_ARGS_OPT(6));
    ...
    mrb_define_method(mrb, cRaylibGlyphInfo, "initialize", mrb_raylib_GlyphInfo_initialize, MRB_ARGS_OPT(5));
    ...
    mrb_define_method(mrb, cRaylibFont, "initialize", mrb_raylib_Font_initialize, MRB_ARGS_OPT(6));
    ...
    mrb_define_method(mrb, cRaylibCamera3D, "initialize", mrb_raylib_Camera3D_initialize, MRB_ARGS_OPT(5));
    ...
    mrb_define_method(mrb, cRaylibCamera2D, "initialize", mrb_raylib_Camera2D_initialize, MRB_ARGS_OPT(4));
    ...
    mrb_define_method(mrb, cRaylibMesh, "initialize", mrb_raylib_Mesh_initialize, MRB_ARGS_OPT(16));
    ...
    mrb_define_method(mrb, cRaylibMesh, "boneCount", mrb_raylib_Mesh_boneCount_get, MRB_ARGS_NONE());
    mrb_define_method(mrb, cRaylibMesh, "boneCount=", mrb_raylib_Mesh_boneCount_set, MRB_ARGS_REQ(1));
    mrb_define_method(mrb, cRaylibMesh, "boneIndices", mrb_raylib_Mesh_boneIndices_get, MRB_ARGS_NONE());
    mrb_define_method(mrb, cRaylibMesh, "boneIndices=", mrb_raylib_Mesh_boneIndices_set, MRB_ARGS_REQ(1));
    ...
    mrb_define_method(mrb, cRaylibShader, "initialize", mrb_raylib_Shader_initialize, MRB_ARGS_OPT(2));
    ...
    mrb_define_method(mrb, cRaylibMaterialMap, "initialize", mrb_raylib_MaterialMap_initialize, MRB_ARGS_OPT(3));
    ...
    mrb_define_method(mrb, cRaylibMaterial, "initialize", mrb_raylib_Material_initialize, MRB_ARGS_OPT(3));
    ...
    mrb_define_method(mrb, cRaylibTransform, "initialize", mrb_raylib_Transform_initialize, MRB_ARGS_OPT(3));
    ...
    mrb_define_method(mrb, cRaylibBoneInfo, "initialize", mrb_raylib_BoneInfo_initialize, MRB_ARGS_OPT(2));
    ...
    cRaylibModelSkeleton = mrb_define_class_under(mrb, mRaylib, "ModelSkeleton", mrb->object_class);
    MRB_SET_INSTANCE_TT(cRaylibModelSkeleton, MRB_TT_DATA);
    mrb_define_class_method(mrb, cRaylibModelSkeleton, "size", mrb_raylib_ModelSkeleton_class_size, MRB_ARGS_NONE());
    mrb_define_method(mrb, cRaylibModelSkeleton, "initialize", mrb_raylib_ModelSkeleton_initialize, MRB_ARGS_OPT(3));
    mrb_define_method(mrb, cRaylibModelSkeleton, "boneCount", mrb_raylib_ModelSkeleton_boneCount_get, MRB_ARGS_NONE());
    mrb_define_method(mrb, cRaylibModelSkeleton, "boneCount=", mrb_raylib_ModelSkeleton_boneCount_set, MRB_ARGS_REQ(1));
    mrb_define_method(mrb, cRaylibModelSkeleton, "bones", mrb_raylib_ModelSkeleton_bones_get, MRB_ARGS_NONE());
    mrb_define_method(mrb, cRaylibModelSkeleton, "bones=", mrb_raylib_ModelSkeleton_bones_set, MRB_ARGS_REQ(1));
    mrb_define_method(mrb, cRaylibModelSkeleton, "bindPose", mrb_raylib_ModelSkeleton_bindPose_get, MRB_ARGS_NONE());
    mrb_define_method(mrb, cRaylibModelSkeleton, "bindPose=", mrb_raylib_ModelSkeleton_bindPose_set, MRB_ARGS_REQ(1));
    ...
    mrb_define_method(mrb, cRaylibModel, "initialize", mrb_raylib_Model_initialize, MRB_ARGS_OPT(9));
    ...
    mrb_define_method(mrb, cRaylibModel, "skeleton", mrb_raylib_Model_skeleton_get, MRB_ARGS_NONE());
    mrb_define_method(mrb, cRaylibModel, "skeleton=", mrb_raylib_Model_skeleton_set, MRB_ARGS_REQ(1));
    mrb_define_method(mrb, cRaylibModel, "currentPose", mrb_raylib_Model_currentPose_get, MRB_ARGS_NONE());
    mrb_define_method(mrb, cRaylibModel, "currentPose=", mrb_raylib_Model_currentPose_set, MRB_ARGS_REQ(1));
    mrb_define_method(mrb, cRaylibModel, "boneMatrices", mrb_raylib_Model_boneMatrices_get, MRB_ARGS_NONE());
    mrb_define_method(mrb, cRaylibModel, "boneMatrices=", mrb_raylib_Model_boneMatrices_set, MRB_ARGS_REQ(1));
    ...
    mrb_define_method(mrb, cRaylibModelAnimation, "initialize", mrb_raylib_ModelAnimation_initialize, MRB_ARGS_OPT(4));
    ...
    mrb_define_method(mrb, cRaylibModelAnimation, "keyframeCount", mrb_raylib_ModelAnimation_keyframeCount_get, MRB_ARGS_NONE());
    mrb_define_method(mrb, cRaylibModelAnimation, "keyframeCount=", mrb_raylib_ModelAnimation_keyframeCount_set, MRB_ARGS_REQ(1));
    mrb_define_method(mrb, cRaylibModelAnimation, "keyframePoses", mrb_raylib_ModelAnimation_keyframePoses_get, MRB_ARGS_NONE());
    mrb_define_method(mrb, cRaylibModelAnimation, "keyframePoses=", mrb_raylib_ModelAnimation_keyframePoses_set, MRB_ARGS_REQ(1));
    ...
    mrb_define_method(mrb, cRaylibRay, "initialize", mrb_raylib_Ray_initialize, MRB_ARGS_OPT(2));
    ...
    mrb_define_method(mrb, cRaylibRayCollision, "initialize", mrb_raylib_RayCollision_initialize, MRB_ARGS_OPT(4));
    ...
    mrb_define_method(mrb, cRaylibBoundingBox, "initialize", mrb_raylib_BoundingBox_initialize, MRB_ARGS_OPT(2));
    ...
    mrb_define_method(mrb, cRaylibWave, "initialize", mrb_raylib_Wave_initialize, MRB_ARGS_OPT(5));
    ...
    mrb_define_method(mrb, cRaylibAudioStream, "initialize", mrb_raylib_AudioStream_initialize, MRB_ARGS_OPT(5));
    ...
    mrb_define_method(mrb, cRaylibSound, "initialize", mrb_raylib_Sound_initialize, MRB_ARGS_OPT(2));
    ...
    mrb_define_method(mrb, cRaylibMusic, "initialize", mrb_raylib_Music_initialize, MRB_ARGS_OPT(5));
    ...
    mrb_define_method(mrb, cRaylibVrDeviceInfo, "initialize", mrb_raylib_VrDeviceInfo_initialize, MRB_ARGS_OPT(9));
    ...
    mrb_define_method(mrb, cRaylibVrStereoConfig, "initialize", mrb_raylib_VrStereoConfig_initialize, MRB_ARGS_OPT(8));
    ...
    mrb_define_method(mrb, cRaylibFilePathList, "initialize", mrb_raylib_FilePathList_initialize, MRB_ARGS_OPT(2));
    ...
    mrb_define_method(mrb, cRaylibAutomationEvent, "initialize", mrb_raylib_AutomationEvent_initialize, MRB_ARGS_OPT(3));
    ...
    mrb_define_method(mrb, cRaylibAutomationEventList, "initialize", mrb_raylib_AutomationEventList_initialize, MRB_ARGS_OPT(3));
    ...
    mrb_define_module_function(mrb, mRaylib, "GetClipboardImage", mrb_raylib_GetClipboardImage, MRB_ARGS_NONE());
    ...
    mrb_define_module_function(mrb, mRaylib, "IsShaderValid", mrb_raylib_IsShaderValid, MRB_ARGS_REQ(1));
    ...
    mrb_define_module_function(mrb, mRaylib, "GetScreenToWorldRay", mrb_raylib_GetScreenToWorldRay, MRB_ARGS_REQ(2));
    mrb_define_module_function(mrb, mRaylib, "GetScreenToWorldRayEx", mrb_raylib_GetScreenToWorldRayEx, MRB_ARGS_REQ(4));
    ...
    mrb_define_module_function(mrb, mRaylib, "FileRename", mrb_raylib_FileRename, MRB_ARGS_REQ(2));
    mrb_define_module_function(mrb, mRaylib, "FileRemove", mrb_raylib_FileRemove, MRB_ARGS_REQ(1));
    mrb_define_module_function(mrb, mRaylib, "FileCopy", mrb_raylib_FileCopy, MRB_ARGS_REQ(2));
    mrb_define_module_function(mrb, mRaylib, "FileMove", mrb_raylib_FileMove, MRB_ARGS_REQ(2));
    mrb_define_module_function(mrb, mRaylib, "FileTextReplace", mrb_raylib_FileTextReplace, MRB_ARGS_REQ(3));
    mrb_define_module_function(mrb, mRaylib, "FileTextFindIndex", mrb_raylib_FileTextFindIndex, MRB_ARGS_REQ(2));
    ...
    mrb_define_module_function(mrb, mRaylib, "MakeDirectory", mrb_raylib_MakeDirectory, MRB_ARGS_REQ(1));
    ...
    mrb_define_module_function(mrb, mRaylib, "IsPathDirectory", mrb_raylib_IsPathDirectory, MRB_ARGS_REQ(1));
    mrb_define_module_function(mrb, mRaylib, "IsPathAbsolute", mrb_raylib_IsPathAbsolute, MRB_ARGS_REQ(1));
    mrb_define_module_function(mrb, mRaylib, "IsFileNameValid", mrb_raylib_IsFileNameValid, MRB_ARGS_REQ(1));
    ...
    mrb_define_module_function(mrb, mRaylib, "GetDirectoryFileCount", mrb_raylib_GetDirectoryFileCount, MRB_ARGS_REQ(1));
    mrb_define_module_function(mrb, mRaylib, "GetDirectoryFileCountEx", mrb_raylib_GetDirectoryFileCountEx, MRB_ARGS_REQ(3));
    ...
    mrb_define_module_function(mrb, mRaylib, "ComputeCRC32", mrb_raylib_ComputeCRC32, MRB_ARGS_REQ(2));
    mrb_define_module_function(mrb, mRaylib, "ComputeMD5", mrb_raylib_ComputeMD5, MRB_ARGS_REQ(2));
    mrb_define_module_function(mrb, mRaylib, "ComputeSHA1", mrb_raylib_ComputeSHA1, MRB_ARGS_REQ(2));
    mrb_define_module_function(mrb, mRaylib, "ComputeSHA256", mrb_raylib_ComputeSHA256, MRB_ARGS_REQ(2));
    ...
    mrb_define_module_function(mrb, mRaylib, "GetKeyName", mrb_raylib_GetKeyName, MRB_ARGS_REQ(1));
    ...
    mrb_define_module_function(mrb, mRaylib, "SetGamepadVibration", mrb_raylib_SetGamepadVibration, MRB_ARGS_REQ(4));
    ...
    mrb_define_module_function(mrb, mRaylib, "GetShapesTexture", mrb_raylib_GetShapesTexture, MRB_ARGS_NONE());
    mrb_define_module_function(mrb, mRaylib, "GetShapesTextureRectangle", mrb_raylib_GetShapesTextureRectangle, MRB_ARGS_NONE());
    ...
    mrb_define_module_function(mrb, mRaylib, "DrawLineDashed", mrb_raylib_DrawLineDashed, MRB_ARGS_REQ(5));
    ...
    mrb_define_module_function(mrb, mRaylib, "GetSplinePointBezierQuadratic", mrb_raylib_GetSplinePointBezierQuadratic, MRB_ARGS_REQ(4));
    ...
    mrb_define_module_function(mrb, mRaylib, "CheckCollisionCircleLine", mrb_raylib_CheckCollisionCircleLine, MRB_ARGS_REQ(4));
    ...
    mrb_define_module_function(mrb, mRaylib, "LoadImageAnimFromMemory", mrb_raylib_LoadImageAnimFromMemory, MRB_ARGS_REQ(4));
    ...
    mrb_define_module_function(mrb, mRaylib, "IsImageValid", mrb_raylib_IsImageValid, MRB_ARGS_REQ(1));
    ...
    mrb_define_module_function(mrb, mRaylib, "ImageFromChannel", mrb_raylib_ImageFromChannel, MRB_ARGS_REQ(2));
    ...
    mrb_define_module_function(mrb, mRaylib, "ImageKernelConvolution", mrb_raylib_ImageKernelConvolution, MRB_ARGS_REQ(3));
    ...
    mrb_define_module_function(mrb, mRaylib, "ImageDrawLineEx", mrb_raylib_ImageDrawLineEx, MRB_ARGS_REQ(5));
    mrb_define_module_function(mrb, mRaylib, "ImageDrawLineStrip", mrb_raylib_ImageDrawLineStrip, MRB_ARGS_REQ(4));
    mrb_define_module_function(mrb, mRaylib, "ImageDrawTriangle", mrb_raylib_ImageDrawTriangle, MRB_ARGS_REQ(5));
    mrb_define_module_function(mrb, mRaylib, "ImageDrawTriangleGradient", mrb_raylib_ImageDrawTriangleGradient, MRB_ARGS_REQ(7));
    mrb_define_module_function(mrb, mRaylib, "ImageDrawTriangleLines", mrb_raylib_ImageDrawTriangleLines, MRB_ARGS_REQ(5));
    mrb_define_module_function(mrb, mRaylib, "ImageDrawTriangleFan", mrb_raylib_ImageDrawTriangleFan, MRB_ARGS_REQ(4));
    mrb_define_module_function(mrb, mRaylib, "ImageDrawTriangleStrip", mrb_raylib_ImageDrawTriangleStrip, MRB_ARGS_REQ(4));
    ...
    mrb_define_module_function(mrb, mRaylib, "ImageDrawRectanglePro", mrb_raylib_ImageDrawRectanglePro, MRB_ARGS_REQ(5));
    mrb_define_module_function(mrb, mRaylib, "ImageDrawRectangleLines", mrb_raylib_ImageDrawRectangleLines, MRB_ARGS_REQ(6));
    mrb_define_module_function(mrb, mRaylib, "ImageDrawRectangleLinesEx", mrb_raylib_ImageDrawRectangleLinesEx, MRB_ARGS_REQ(4));
    mrb_define_module_function(mrb, mRaylib, "ImageDrawRectangleGradientEx", mrb_raylib_ImageDrawRectangleGradientEx, MRB_ARGS_REQ(6));
    ...
    mrb_define_module_function(mrb, mRaylib, "ImageDrawCircleGradient", mrb_raylib_ImageDrawCircleGradient, MRB_ARGS_REQ(5));
    mrb_define_module_function(mrb, mRaylib, "ImageDrawImage", mrb_raylib_ImageDrawImage, MRB_ARGS_REQ(5));
    mrb_define_module_function(mrb, mRaylib, "ImageDrawImageEx", mrb_raylib_ImageDrawImageEx, MRB_ARGS_REQ(6));
    mrb_define_module_function(mrb, mRaylib, "ImageDrawImageRec", mrb_raylib_ImageDrawImageRec, MRB_ARGS_REQ(5));
    mrb_define_module_function(mrb, mRaylib, "ImageDrawImagePro", mrb_raylib_ImageDrawImagePro, MRB_ARGS_REQ(7));
    ...
    mrb_define_module_function(mrb, mRaylib, "ImageDrawTextPro", mrb_raylib_ImageDrawTextPro, MRB_ARGS_REQ(9));
    ...
    mrb_define_module_function(mrb, mRaylib, "ColorIsEqual", mrb_raylib_ColorIsEqual, MRB_ARGS_REQ(2));
    ...
    mrb_define_module_function(mrb, mRaylib, "ColorLerp", mrb_raylib_ColorLerp, MRB_ARGS_REQ(3));
    ...
    mrb_define_module_function(mrb, mRaylib, "IsFontValid", mrb_raylib_IsFontValid, MRB_ARGS_REQ(1));
    mrb_define_module_function(mrb, mRaylib, "LoadFontData", mrb_raylib_LoadFontData, MRB_ARGS_REQ(7));
    ...
    mrb_define_module_function(mrb, mRaylib, "MeasureTextCodepoints", mrb_raylib_MeasureTextCodepoints, MRB_ARGS_REQ(5));
    ...
    mrb_define_module_function(mrb, mRaylib, "LoadTextLines", mrb_raylib_LoadTextLines, MRB_ARGS_REQ(2));
    mrb_define_module_function(mrb, mRaylib, "UnloadTextLines", mrb_raylib_UnloadTextLines, MRB_ARGS_REQ(2));
    ...
    mrb_define_module_function(mrb, mRaylib, "TextRemoveSpaces", mrb_raylib_TextRemoveSpaces, MRB_ARGS_REQ(1));
    mrb_define_module_function(mrb, mRaylib, "GetTextBetween", mrb_raylib_GetTextBetween, MRB_ARGS_REQ(3));
    mrb_define_module_function(mrb, mRaylib, "TextReplace", mrb_raylib_TextReplace, MRB_ARGS_REQ(3));
    mrb_define_module_function(mrb, mRaylib, "TextReplaceAlloc", mrb_raylib_TextReplaceAlloc, MRB_ARGS_REQ(3));
    mrb_define_module_function(mrb, mRaylib, "TextReplaceBetween", mrb_raylib_TextReplaceBetween, MRB_ARGS_REQ(4));
    mrb_define_module_function(mrb, mRaylib, "TextReplaceBetweenAlloc", mrb_raylib_TextReplaceBetweenAlloc, MRB_ARGS_REQ(4));
    mrb_define_module_function(mrb, mRaylib, "TextInsert", mrb_raylib_TextInsert, MRB_ARGS_REQ(3));
    mrb_define_module_function(mrb, mRaylib, "TextInsertAlloc", mrb_raylib_TextInsertAlloc, MRB_ARGS_REQ(3));
    ...
    mrb_define_module_function(mrb, mRaylib, "TextToSnake", mrb_raylib_TextToSnake, MRB_ARGS_REQ(1));
    mrb_define_module_function(mrb, mRaylib, "TextToCamel", mrb_raylib_TextToCamel, MRB_ARGS_REQ(1));
    mrb_define_module_function(mrb, mRaylib, "TextToInteger", mrb_raylib_TextToInteger, MRB_ARGS_REQ(1));
    mrb_define_module_function(mrb, mRaylib, "TextToFloat", mrb_raylib_TextToFloat, MRB_ARGS_REQ(1));
    ...
    mrb_define_module_function(mrb, mRaylib, "IsModelValid", mrb_raylib_IsModelValid, MRB_ARGS_REQ(1));
    ...
    mrb_define_module_function(mrb, mRaylib, "ExportMeshAsCode", mrb_raylib_ExportMeshAsCode, MRB_ARGS_REQ(2));
    ...
    mrb_define_module_function(mrb, mRaylib, "IsMaterialValid", mrb_raylib_IsMaterialValid, MRB_ARGS_REQ(1));
    ...
    mrb_define_module_function(mrb, mRaylib, "UpdateModelAnimationEx", mrb_raylib_UpdateModelAnimationEx, MRB_ARGS_REQ(6));
    ...
    mrb_define_module_function(mrb, mRaylib, "IsWaveValid", mrb_raylib_IsWaveValid, MRB_ARGS_REQ(1));
    ...
    mrb_define_module_function(mrb, mRaylib, "IsSoundValid", mrb_raylib_IsSoundValid, MRB_ARGS_REQ(1));
    ...
    mrb_define_module_function(mrb, mRaylib, "IsMusicValid", mrb_raylib_IsMusicValid, MRB_ARGS_REQ(1));
    ...
    mrb_define_module_function(mrb, mRaylib, "IsAudioStreamValid", mrb_raylib_IsAudioStreamValid, MRB_ARGS_REQ(1));
